...
export const onChangePage = (page) => {
  ...
  USER_UPDATE_PAGE.className = "d-none";
  CONTENT_DETAILS_PAGE.className = "d-none";
  CARDS_FROM_FAVORITES_PAGE.className = "d-none";
  ...
  if (page === PAGES.CARDS_FROM_FAVORITES)
    return (CARDS_FROM_FAVORITES_PAGE.className = "d-block");
  if (page === PAGES.CONTENT_DETAILS)
    return (CONTENT_DETAILS_PAGE.className = "d-block");
  if (page === PAGES.USER_UPDATE)
    return (USER_UPDATE_PAGE.className = "d-block");
